...
| 에이전트 | 담당 |
|---------|------|
| backend-dev | Node.js/Express/Socket.io — `server/src/` |
| flutter-dev | Flutter 앱 + WebView — `app/lib/` |
...
| LiveKit 토큰 발급 API | livekit-specialist → backend-dev | qa |
| LiveKit WebView HTML/JS 클라이언트 | livekit-specialist | flutter-dev |
