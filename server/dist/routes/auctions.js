...
router.post('/batch-ship', async (req, res) => {
    ...
    try {
        ...
        await mysql_1.default.execute(`UPDATE auctions SET shipping_fee_status='paid', shipping_fee=? WHERE id IN (${placeholders})`, [shippingFee, ...auctionIds]);
...
router.get('/:id/recommendations', async (req, res) => {
    ...
    try {
        ...
        const recommendations = (0, productRecommender_1.getRecommendations)(row.product_name);
